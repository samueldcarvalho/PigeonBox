    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 8, 3, 22, 41, 13, 321, DateTimeKind.Local).AddTicks(2448), new DateTime(2022, 8, 3, 22, 41, 13, 321, DateTimeKind.Local).AddTicks(2465), "admin@admin.com.br", "Administrador", "@Asd123456789", false, "admin" });

            migrationBuilder.InsertData(
                table: "chat",
                columns: new[] { "id", "altered_at", "created_at", "description", "removed", "title", "unique_identifier", "user_id" },
                values: new object[] { 1, new DateTime(2022, 8, 3, 22, 41, 13, 267, DateTimeKind.Local).AddTicks(6593), new DateTime(2022, 8, 3, 22, 41, 13, 268, DateTimeKind.Local).AddTicks(9946), new byte[] { 87, 101, 108, 99, 111, 109, 101, 32, 116, 111, 32, 80, 105, 103, 101, 111, 110, 98, 111, 120, 33, 32, 84, 104, 105, 115, 32, 111, 110, 101, 32, 97, 32, 103, 108, 111, 98, 97, 108, 32, 99, 104, 97, 116, 44, 32, 102, 111, 114, 32, 101, 118, 101, 114, 121, 32, 80, 105, 103, 101, 111, 110, 32, 105, 110, 32, 116, 104, 105, 115, 32, 98, 111, 120, 46, 32, 66, 101, 32, 114, 101, 115, 112, 101, 99, 116, 102, 117, 108, 33, 32, 65, 116, 116, 46, 46, 32, 83, 97, 109, 117, 101, 108, 32, 61, 41, 32 }, false, "#Everyone", new Guid("b406a7d5-3034-4e07-b9ed-5da33d6ac09f"), 1 });
